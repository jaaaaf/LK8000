...
TCHAR szRegistryFlags_DrawFAI[] = _T("Flags_DrawFAI");
TCHAR szRegistryFlags_DrawTask[] = _T("Flags_DrawTask");
...
extern TCHAR szRegistryFlags_DrawFAI[];
extern TCHAR szRegistryFlags_DrawTask[];
